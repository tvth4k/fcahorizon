...
```bash
npm i fca-horizon-tvt
```
or
```bash
npm install fca-horizon-tvt
```
...
```javascript
const login = require("fca-horizon-tvt"); // lấy từ lib ra 
...
```js
    var login = require('fca-horizon-tvt')
```
...
```js
const fs = require("fs");
const login = require("fca-horizon-tvt");
